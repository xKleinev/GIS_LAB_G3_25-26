...
addDecoder(7, () => import("./jpeg-U2M7JJJZ.js").then((m) => m.default));
addDecoder([8, 32946], () => import("./deflate-YNDMJLOV.js").then((m) => m.default));
addDecoder(32773, () => import("./packbits-JNNBCSJ4.js").then((m) => m.default));
addDecoder(
  34887,
  () => import("./lerc-GG3EKXT4.js").then(async (m) => {
    await m.zstd.init();
    return m;
  }).then((m) => m.default)
);
